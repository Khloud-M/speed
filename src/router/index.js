...
import addAdvi from "@/views/addAdvi.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/addAdvi", component: addAdvi },
    ...
    {path:"/filter/:id", component:filterComp , name:'filterComp' , props:true},
    { path: "/item/:id", component: itemDetails, name:'itemDetails' , props: true  },
    // userAccount Page
